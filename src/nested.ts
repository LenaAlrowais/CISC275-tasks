...
export function toCSV(questions: Question[]): string {
    ...
    const rows = questions.map(function (question: Question) {
        return [
            question.id,
            question.name,
...
export function makeAnswers(questions: Question[]): Answer[] {
    return questions.map(function (question: Question): Answer {
        return {
...
export function publishAll(questions: Question[]): Question[] {
    return questions.map(function (question: Question): Question {
...
export function sameType(questions: Question[]): boolean {
    ...
    return questions.every(function (question: Question) {
        return question.type === firstType;
    });
}
